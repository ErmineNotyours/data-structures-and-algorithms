...
namespace PrintLevelOrderTest
{
    public class UnitTest1
    {
        ...
        public void TreeTest1()
        {
            ...
            // Assert
            Assert.Equal("A**NEWLINE**BCDEFG**NEWLINE**HIJKLM**NEWLINE**NOPQ", Program.PrintLevelOrder(nodeA));
        ...
        public void TreeTest2()
        {
            ...
            // Assert
            Assert.Equal("A**NEWLINE**BC", Program.PrintLevelOrder(nodeA));
        }
        ...
        public void TreeTest3()
        {
            ...
            // Assert
            Assert.Equal("A", Program.PrintLevelOrder(nodeA));
        }
    }
}
